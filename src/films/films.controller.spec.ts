...
describe('FilmsController', () => {
  ...
  it('/POST create film', async () => {
    const createFilmDTO: CreateFilmDTO = {
      ...
      "description": "Reclusive and controversial author Bruce Cogburn is drawn out of hiding by an obsessive fan",
      "poster_path": "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/aVWD3YLIkbkApXF2ntRHgK8J0Je.jpg",
      "country": "USA",
